...
# Exercise 1: Foundations of PGx

This exercise set is designed to reinforce the core ideas from **Module 1: Foundations of PGx**.

## Learning Goals

By completing these exercises, the learner should be able to:

- define PGx in simple terms
- distinguish pharmacokinetics from pharmacodynamics
- recognize the role of prodrugs
- understand different ways genetics can affect drug response
- explain why PGx is important but not sufficient on its own
...
For a more advanced follow-up, the learner can try to answer:

- How might PGx affect a prodrug differently from an active drug?
- Why can the same genotype still lead to different outcomes in different patients?
- What types of genes are likely to matter in PGx?

These questions prepare the learner for **Module 2: Core PGx Genes and Mechanisms**.